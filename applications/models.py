...
class Application(models.Model):
    ...
    neighborhood_notification_details = models.CharField(blank=True, max_length=2048)
    neighborhood_notification_feedback = models.CharField(blank=True, max_length=2048)
