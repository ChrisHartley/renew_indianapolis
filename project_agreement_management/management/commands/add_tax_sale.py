...
class Command(BaseCommand):
    help = 'Given a list of tax sale slated properties, create enforcements and breeches'
    ...
    def handle(self, *args, **options):
        ...
        tax_sale = BreechType.objects.get(name='Slatted for Tax Sale')
        ...
        if options['comprehensive'] == True:
            ...
            #    print(dir(e))
                for b in e.breechstatus_set.all():
                    if b.breech == tax_sale and b.date_resolved is None:
        ...
        for p in props:
            ...
            has_tax_sale_breech = False
            for e in enforcements:
                    for b in e.breech_types.all():
                        if b == tax_sale:
                            has_tax_sale_breech = True
            if has_tax_sale_breech == False:
                ...
                if enf is None:
                    ...
                    enf.save()
                bs = BreechStatus(breech=tax_sale, enforcement=enf, date_created=date.today())
                bs.save()
                print(enf)
