    ...
    def render_to_response(self, context, **response_kwargs):
        ...
        for index,meeting_link in enumerate(context['meeting'].meeting_link.all().order_by('application__application_type'), 1):
            ...
            if application.organization is None:
                ...
                organization_worksheet.write(organization_index, organization_header.index('Address.Address 1'), application.organization.mailing_address_line1, text_format)
                organization_worksheet.write(organization_index, organization_header.index('Address.City'), application.organization.mailing_address_city, text_format)
                organization_worksheet.write(organization_index, organization_header.index('Address.State'), application.organization.mailing_address_state, text_format)
                organization_worksheet.write(organization_index, organization_header.index('Address.Postal Code'), application.organization.mailing_address_zip, text_format)
                organization_worksheet.write(organization_index, organization_header.index('Address.Address 2'), application.organization.mailing_address_line2, text_format)
                organization_worksheet.write(organization_index, organization_header.index('Email'), application.organization.email, text_format)
                organization_worksheet.write(organization_index, organization_header.index('Function'), 'Owner|Buyer', text_format)
                organization_worksheet.write(organization_index, organization_header.index('Telephone'), application.organization.phone_number, text_format)
