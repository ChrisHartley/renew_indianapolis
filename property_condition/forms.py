...
#		self.helper.label_class = 'col-lg-3'
        ...
        self.helper.layout = Layout(
            ...
            Fieldset(
                'Exterior Siding',
                Div('exterior_siding_brick',
                    'exterior_siding_brick_notes'),
                Div('exterior_siding_vinyl',
                    'exterior_siding_vinyl_notes'),
                Div('exterior_siding_wood',
                    'exterior_siding_wood_notes'),
                Div('exterior_siding_other',
            ...
            Fieldset(
                'Flooring',
                Div('flooring_subflooring',
                    'flooring_subflooring_notes'),
